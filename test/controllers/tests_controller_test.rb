...
class TestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create test" do
    assert_difference('Test.count') do
      post tests_url, params: { test: { Absence: @test.Absence, Array: @test.Array, N: @test.N } }
    end
  ...
  test "should update test" do
    patch test_url(@test), params: { test: { Absence: @test.Absence, Array: @test.Array, N: @test.N } }
